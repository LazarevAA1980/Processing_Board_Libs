...
HD_PWD='D:/Projects/TERRA/PLIS/terra_test/terra_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_K5101HB04FI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADC_K5101HB04FI.tcl -notrace
