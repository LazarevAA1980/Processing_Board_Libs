...
HD_PWD='D:/Projects/TERRA/PLIS/terra_test/terra_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_K5101HB04FI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_K5101HB04FI.tcl
