...
#### DDR3
set_property PACKAGE_PIN W1   [get_ports {DDR3_A[0]}]
set_property PACKAGE_PIN AA3  [get_ports {DDR3_A[1]}]
set_property PACKAGE_PIN Y2   [get_ports {DDR3_A[2]}]
set_property PACKAGE_PIN Y4   [get_ports {DDR3_A[3]}]
set_property PACKAGE_PIN AB2  [get_ports {DDR3_A[4]}]
set_property PACKAGE_PIN AB1  [get_ports {DDR3_A[5]}]
set_property PACKAGE_PIN AA5  [get_ports {DDR3_A[6]}]
set_property PACKAGE_PIN AA1  [get_ports {DDR3_A[7]}]
set_property PACKAGE_PIN AB3  [get_ports {DDR3_A[8]}]
set_property PACKAGE_PIN AB5  [get_ports {DDR3_A[9]}]
set_property PACKAGE_PIN V2   [get_ports {DDR3_A[10]}]
set_property PACKAGE_PIN AA6  [get_ports {DDR3_A[11]}]
set_property PACKAGE_PIN Y6   [get_ports {DDR3_A[12]}]
set_property PACKAGE_PIN AB6  [get_ports {DDR3_A[13]}]
set_property PACKAGE_PIN AA4  [get_ports {DDR3_A[14]}]
#set_property IOSTANDARD  LVCMOS25 [get_ports {DDR3_A[*]}]  
...
#set_property IOSTANDARD  LVCMOS25 [get_ports {DDR3_D[*]}]  
